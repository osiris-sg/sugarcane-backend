...
import { Shield, Crown, User, Check, X, Briefcase, Truck } from "lucide-react";
...
const roles = [
  ...
  },
  {
    ...
    icon: Truck,
    color: "orange",
    description: "Operations staff for maintenance and deliveries",
    permissions: [
      { name: "View Sales Overview", allowed: false },
      { name: "View Device Management", allowed: true },
      { name: "View Order Management", allowed: false },
      { name: "Access Operations Dashboard", allowed: true },
      { name: "Manage Users", allowed: false },
      { name: "Create/Edit/Delete Devices", allowed: false },
      { name: "Manage Device Groups", allowed: false },
